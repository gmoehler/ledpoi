...
// -> non-iso functions are converted using snprinf
...
unsigned char String::concat(unsigned char num)
{
    ...
    // itoa(num, buf, 10);
    snprintf(buf, 1 + 3 * sizeof(unsigned char), "%ud", num);
...
unsigned char String::concat(int num)
{
    ...
    // itoa(num, buf, 10);
    snprintf(buf, 2 + 3 * sizeof(int), "%d", num);
    return concat(buf, strlen(buf));
}
...
unsigned char String::concat(unsigned int num)
{
    ...
    // utoa(num, buf, 10);
    snprintf(buf, 1 + 3 * sizeof(unsigned int), "%u", num);
    return concat(buf, strlen(buf));
}
...
unsigned char String::concat(long num)
{
    ...
    //ltoa(num, buf, 10);
    snprintf(buf, 2 + 3 * sizeof(long), "%ld", num);
    return concat(buf, strlen(buf));
}
...
unsigned char String::concat(unsigned long num)
{
    ...
    // ultoa(num, buf, 10);
    snprintf(buf, 1 + 3 * sizeof(unsigned long), "%lu", num);
    return concat(buf, strlen(buf));
}
