...
TEST(FadeHandler_tests, afterDeclaration){
  ...
  EXPECT_EQ(fadeHandler._getCurrentFadeFactor(), 0);
...
TEST(FadeHandler_tests, afterInit){
  ...
  EXPECT_EQ(fadeHandler._getCurrentFadeFactor(), 1.0);
...
TEST(FadeHandler_tests, testNext){
  ...
  EXPECT_EQ(fadeHandler._getCurrentFadeFactor(), 1.0);
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.98, 2);
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.96, 2);
}
...
TEST(FadeHandler_tests, testNextSmallFadeTime1){
  ...
  EXPECT_EQ(fadeHandler._getCurrentFadeFactor(), 1.0);
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.8, 1);
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.6, 1);
}
...
TEST(FadeHandler_tests, testNextSmallFadeTime2){
  ...
  EXPECT_EQ(fadeHandler._getCurrentFadeFactor(), 1.0);
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0, 1);
  rgbVal* reg0= fadeHandler.getDisplayFrame();
...
TEST(FadeHandler_tests, testFinished){
  ...
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.01, 2);
  EXPECT_TRUE(fadeHandler.isActive());
  EXPECT_FALSE(fadeHandler.isLastStep());

  // last iteration
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.00, 2);
  EXPECT_TRUE(fadeHandler.isActive());
...
TEST(FadeHandler_tests, testFinishedSmallFadeTime1){
  ...
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.1, 1);
  EXPECT_TRUE(fadeHandler.isActive());

  // last iteration
  fadeHandler.next();
  EXPECT_EQ_FLOATPREC(fadeHandler._getCurrentFadeFactor(), 0.0, 1);
  EXPECT_TRUE(fadeHandler.isActive());
  EXPECT_TRUE(fadeHandler.isLastStep());
